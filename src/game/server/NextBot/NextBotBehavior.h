...
public:
	...
	virtual EventDesiredResult< Actor > OnSpokeConcept( Actor *me, CBaseCombatCharacter *who, AIConcept_t koncept, AI_Response *response )	{ return TryContinue(); }
...
private:
	...
	virtual void OnSpokeConcept( CBaseCombatCharacter *who, AIConcept_t koncept, AI_Response *response )	{ PROCESS_EVENT_WITH_3_ARGS( OnSpokeConcept, who, koncept, response ); }
