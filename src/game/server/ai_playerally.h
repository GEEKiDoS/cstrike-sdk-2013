...
public:
	...
	ConceptInfo_t *GetConceptInfo( AIConcept_t koncept );
	void OnSpokeConcept( CAI_PlayerAlly *pPlayerAlly, AIConcept_t koncept, AI_Response *response  );
	...
	bool ConceptDelayExpired( AIConcept_t koncept );
...
public:
	...
	virtual void PostSpeakDispatchResponse( AIConcept_t koncept, AI_Response *response );
	...
	bool 		SelectSpeechResponse( AIConcept_t koncept, const char *pszModifiers, CBaseEntity *pTarget, AISpeechSelection_t *pSelection );
	void		SetPendingSpeech( AIConcept_t koncept, AI_Response &Response );
	...
	bool		ShouldSpeakRandom( AIConcept_t koncept, int iChance );
	bool		IsAllowedToSpeak( AIConcept_t koncept, bool bRespondingToPlayer = false );
	virtual bool SpeakIfAllowed( AIConcept_t koncept, const char *modifiers = NULL, bool bRespondingToPlayer = false, char *pszOutResponseChosen = NULL, size_t bufsize = 0 );
	...
	void		OnSpokeConcept( AIConcept_t koncept, AI_Response *response );
