...
{
#ifdef	GAME_DLL
	return ( steamgameserverapicontext && steamgameserverapicontext->SteamGameServer() && steamgameserverapicontext->SteamGameServerUtils() );
#elif	CLIENT_DLL
...
ISteamGameStats* CSteamWorksGameStatsUploader::GetInterface( void )
{
	...
	if (steamgameserverapicontext && engine && (/*engine->IsDedicatedServerForXbox() ||*/ engine->IsDedicatedServer()) )
	{
