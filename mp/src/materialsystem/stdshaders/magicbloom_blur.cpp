...
#include "magicbloom_blur1_ps30.inc"
#include "magicbloom_blur2_ps30.inc"

ConVarRef mat_magicbloom_threshold("mat_magicbloom_threshold");
ConVarRef mat_magicbloom_intensity("mat_magicbloom_intensity");
...
SHADER_PARAM(SCALE, SHADER_PARAM_TYPE_FLOAT, "2", "Blur Scale")
END_SHADER_PARAMS
...
SHADER_DRAW
{
	...
	DYNAMIC_STATE
	{
		...
		pShaderAPI->SetPixelShaderConstant(3, texelSize);
