...
public:
	...
	bool InitializeAsClientEntity(const char* pszModelName, RenderGroup_t rg);
...
public:
	...
	C_ViewmodelAttachmentModel* AddViewmodelArmModel(const char* pszModel);
	void					RemoveViewmodelArmModels(void);
	void					UpdateAllViewmodelAddons(int);
